...
const allItems = {
  Food: {image:"food.jpg", price: 75, description:"You need food to feed yourself and any characters you hire every few turn.", onlyOne:false},
  ...
  Tires:{image:"tire.png", price: 375, description: "Not sure why a flying space car needs tires, but you're going to want at least four running well.", onlyOne:false},
  ...
  Lasers: {image:"laser.jpg", price: 660, description:"Nothing persuades people more than a giant death cannon. Use them is self defense or for more nefarious means.", onlyOne:false},
  ...
  Hunter: {image:"person.jpg", price:440, description:"Gives you food at planets or places where you can hunt.", onlyOne:true},
}//Add new items here
const rareItems = {
  level1:{},
  level2:{},
